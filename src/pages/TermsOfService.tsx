        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-12">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    By using Slimeguard Bot, you agree to these terms. Please read them carefully before adding the bot to your server.
                  </p>
                </div>
              </div>
            </div>
            ...
            <section>
              ...
              <div className="glass p-6 rounded-lg space-y-4">
                <p className="text-gray-300">
                  By inviting Slimeguard Bot to your Discord server, you agree to these terms of service and privacy policy. You acknowledge that you have the authority to accept these terms on behalf of your server.
                </p>
                <p className="text-gray-300">
                  You may not use Slimeguard Bot for any illegal or unauthorized purpose. You must comply with all Discord's Terms of Service and Community Guidelines.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="glass p-6 rounded-lg space-y-4">
                <p className="text-gray-300">
                  While we strive to provide uninterrupted service, Slimeguard Bot is provided "as is" and we make no guarantees about its availability. We reserve the right to modify, suspend, or discontinue the service at any time without notice.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="glass p-6 rounded-lg space-y-4">
                <p className="text-gray-300">
                  Slimeguard Bot collects and stores minimal data necessary for functionality. This includes:
                </p>
                <ul className="list-disc list-inside text-gray-300 space-y-2">
            ...
            <section>
              ...
              <div className="glass p-6 rounded-lg space-y-4">
                <p className="text-gray-300">
                  We reserve the right to modify these terms at any time. Continued use of Slimeguard Bot after changes constitutes acceptance of the new terms.
                </p>
              </div>
            </section>
